...
export class BillsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.billsService
      ...
      .subscribe(
        (res: HttpResponse<IBills[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInBills(): void {
    this.eventSubscriber = this.eventManager.subscribe('billsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IBills[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
