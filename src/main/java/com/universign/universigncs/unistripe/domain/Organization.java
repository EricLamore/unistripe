...
public class Organization implements Serializable {
    ...
    public Organization organisationId(String organisationId) {
    ...
    public Price getOrganization() {
        return organization;
    }

    public Organization organization(Price price) {
        this.organization = price;
        return this;
    }

    public void setOrganization(Price price) {
        this.organization = price;
    }
