...
public class Price implements Serializable {
    ...
    public StripeSubscription getSubscription() {
        return subscription;
    }

    public Price subscription(StripeSubscription stripeSubscription) {
